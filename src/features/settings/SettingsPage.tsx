    ...
    <PageContainer>
      ...
      <section className="flex flex-col gap-2 rounded-xl bg-zinc-900 p-4">
        ...
        <p className="text-xs text-zinc-600">
          Seluruh data (gerakan, routine, catatan harian, dan riwayat sesi) diunduh sebagai satu
          file JSON. Lakukan secara berkala supaya data tidak hilang kalau perangkat berganti atau
          aplikasi terhapus.
        </p>
      </section>
